...
return [
    ...
    */
    ...
    |
    */
    'entity' => Railken\LaraOre\WorkLog\WorkLog::class,
    ...
    |
    */
    'manager' => Railken\LaraOre\WorkLog\WorkLogManager::class,
    ...
    |
    */
    'repository' => Railken\LaraOre\WorkLog\WorkLogRepository::class,
    ...
    |
    */
    'serializer' => Railken\LaraOre\WorkLog\WorkLogSerializer::class,
    ...
    |
    */
    'validator' => Railken\LaraOre\WorkLog\WorkLogValidator::class,
    ...
    |
    */
    'authorizer' => Railken\LaraOre\WorkLog\WorkLogAuthorizer::class,
