...
return [
    ...
    */
    ...
    |
    */
    'entity' => Railken\LaraOre\Work\Work::class,
    ...
    |
    */
    'manager' => Railken\LaraOre\Work\WorkManager::class,
    ...
    |
    */
    'repository' => Railken\LaraOre\Work\WorkRepository::class,
    ...
    |
    */
    'serializer' => Railken\LaraOre\Work\WorkSerializer::class,
    ...
    |
    */
    'validator' => Railken\LaraOre\Work\WorkValidator::class,
    ...
    |
    */
    'authorizer' => Railken\LaraOre\Work\WorkAuthorizer::class,
    ...
    */
    'http' => [
        'admin' => [
            'enabled'    => true,
            'controller' => Railken\LaraOre\Http\Controllers\Admin\WorksController::class,
            'router'     => [
                'prefix'      => '/works',
            ],
        ],
